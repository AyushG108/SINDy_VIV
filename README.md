...
$$
\dot{q} = -0.0111 - 0.206q + 1.025u + 0.008U_r + 0.082qU_r - 0.013uU_r - 0.002U_r^2 + 0.002q^3 + 0.007q^2u - 0.009u^2 - 0.008qU_r^2 + 0.001uU_r^2
$$

$$
\dot{u} = -0.0241 + 2.845q - 4.848u + 0.016U_r - 1.223qU_r + 2.059uU_r - 0.003U_r^2 + 0.010q^3 - 0.162q^2u - 0.060qu^2 + 0.090qU_r^2 + 0.026u^3 - 0.209uU_r^2
$$
